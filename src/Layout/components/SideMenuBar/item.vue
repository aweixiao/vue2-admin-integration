<template>
  <div>
    ...
    <template
      ...
      <el-menu-item :index="resolvePath(onlyOneChild.path)">
        <div style="display: flex;align-items: center">
          <svg-icon v-if="onlyOneChild.meta && onlyOneChild.meta.icon" :icon="onlyOneChild.meta.icon"></svg-icon>
    ...
    <el-submenu v-else :index="resolvePath(route.path)">
      <template slot="title">
        <div style="display: flex;align-items: center">
          <svg-icon v-if="route.meta && route.meta.icon" :icon="route.meta.icon"></svg-icon>
